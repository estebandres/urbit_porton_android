 ...
 */
public class CreateUserOnUMod extends SimpleUseCase<CreateUserOnUMod.RequestValues, CreateUserOnUMod.ResponseValues> {

    private final UModsRepository mUModsRepository;

    @Inject
    public CreateUserOnUMod(@NonNull UModsRepository uModsRepository,
