...
import com.urbit_iot.porton.TestUtils;
...
public class TaskDetailScreenTest {
    ...
    /**
     * {@link UMod} stub that is added to the fake service API layer.
     */
    private static UMod ACTIVE_TASK = new UMod(TASK_TITLE, TASK_DESCRIPTION, false);

    /**
     * {@link UMod} stub that is added to the fake service API layer.
     */
    private static UMod COMPLETED_TASK = new UMod(TASK_TITLE, TASK_DESCRIPTION, true);
     ...
     */
    @Rule
    public ActivityTestRule<UModInfoActivity> mTaskDetailActivityTestRule =
            new ActivityTestRule<>(UModInfoActivity.class, true /* Initial touch mode  */,
    ...
    private void startActivityWithWithStubbedTask(UMod task) {
        ...
        ((PortONApplication) InstrumentationRegistry.getTargetContext()
        ...
        startIntent.putExtra(UModInfoActivity.EXTRA_TASK_ID, task.getId());
