...
/**
 * Deletes a {@link UMod} from the {@link UModsRepository}.
 */
public class DeleteUMod extends CompletableUseCase<DeleteUMod.RequestValues> {

    private final UModsRepository uModsRepository;

    @Inject
    public DeleteUMod(@NonNull UModsRepository tasksRepository,
    ...
    protected void complete(RequestValues values) {
        uModsRepository.deleteUMod(values.getUModUUID());
    }
